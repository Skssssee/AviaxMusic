...
API_KEY = getenv("API_KEY", '30DxNexGenBotse03654') # youtube song api key, generate free key or buy paid plan from https://console.nexgenbots.xyz

UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Skssssee/AviaxMusic",
)
